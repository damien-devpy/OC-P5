...
CREATE TABLE IF NOT EXISTS product (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, barre_code BIGINT NOT NULL, name VARCHAR(200) NOT NULL, nutrition_grade CHAR(1) NOT NULL, brand VARCHAR(200), store VARCHAR(100), ingredients VARCHAR(3000), quantity CHAR(50));
